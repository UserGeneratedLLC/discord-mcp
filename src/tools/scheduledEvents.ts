...
const tools = [
  ...
  defineTool({
    ...
    schema: z.object({
      ...
      scheduled_start_time: z.iso.datetime({ offset: true }).describe("Event start as an ISO 8601 datetime, e.g. '2026-06-01T20:00:00Z'. Must be in the future."),
      scheduled_end_time: z.iso.datetime({ offset: true }).optional().describe("Event end as an ISO 8601 datetime. Required for EXTERNAL events."),
      ...
      image: z.url().optional().describe("Optional cover image URL."),
    }),
  ...
  defineTool({
    ...
    schema: z.object({
      ...
      scheduled_start_time: z.iso.datetime({ offset: true }).optional().describe("New start time as an ISO 8601 datetime."),
      scheduled_end_time: z.iso.datetime({ offset: true }).optional().describe("New end time as an ISO 8601 datetime."),
      ...
      image: z.url().optional().describe("New cover image URL."),
